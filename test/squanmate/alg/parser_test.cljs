...
(deftest algorithm-test []
  ...
  (is (= (either/right [slice (rotate-top -3) (rotate-bottom 0)
                        slice (rotate-top 0) (rotate-bottom 3)
                        slice (rotate-top 0) (rotate-bottom -3)
                        slice (rotate-top 0) (rotate-bottom 3)
                        slice (rotate-top 2) (rotate-bottom 0)
                        slice (rotate-top 0) (rotate-bottom 2)
                        slice (rotate-top -2) (rotate-bottom 0)
                        slice (rotate-top 4) (rotate-bottom 0)
                        slice (rotate-top 0) (rotate-bottom -2)
                        slice (rotate-top 0) (rotate-bottom 2)
